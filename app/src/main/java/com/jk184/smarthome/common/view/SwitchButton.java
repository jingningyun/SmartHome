...
/**
 * SwitchButton.
 * git:https://github.com/zcweng/SwitchButton/blob/master/library/src/main/java/com/suke/widget/SwitchButton.java
 * attrs:switch_button_attrs.xml
 *      //--------------------------------------------
...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        shadowRadius = optPixelSize(typedArray,
                ...
                dp2pxInt(2.5f));//dp2pxInt(background2.5f);
